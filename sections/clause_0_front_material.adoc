...
The aim of the Vertical extent demo service profile is to provide a standard interface for accessing Vertical extent demo data based on OGC API-EDR standard.
