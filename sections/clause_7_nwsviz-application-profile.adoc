...
include::../requirements/requirements_class_nwsviz-application-profile-demo.adoc[]
...
include::../requirements/core/REQ_HREF-parameter-names.adoc[]
include::../requirements/core/REQ_NBM-parameter-names.adoc[]
include::../requirements/core/REQ_LREF-parameter-names.adoc[]
include::../requirements/core/REQ_LREF_TLE-parameter-names.adoc[]
